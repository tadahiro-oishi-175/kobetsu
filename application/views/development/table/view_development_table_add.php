<html>    
    ...
    <body>
        <div id="main">
            <?= form_open("SpecController/AddSpecDevelopment/$specObj->SpecID/$prodObj->ProductID"); ?>
            <label>仕様詳細</label>
            <table class="InputForm">
                ...
                <tr>
                    <th>ドライバーバージョン</th>
                    <td><?= form_input('DevDriverVersion', '', 'style="width:150px;"') ?></td>
                </tr>
            </table>
            <?php echo form_submit('submit_AddSpecDevelopment', '保存'); ?>
            <?php echo form_close(); ?> 
        </div>
    </body>
</html>